...
export const I18N = {
  vi: {
    ...
    features: {
      tag: "TACTICAL SYSTEMS // 4 TRỤ CỘT",
      ...
      card1_title: "Khoang Cách Ly Tuyệt Đối (Container Isolation)",
      card1_jp: "「完全独立・コンテナ分離」",
      card1_desc: "Mỗi bản game là một không gian độc lập tuyệt đối. Mods, saves, shaders, Java và cấu hình JVM tách biệt hoàn toàn — thử modpack mới không bao giờ ảnh hưởng thế giới cũ.",
  ...
  en: {
    ...
    features: {
      tag: "TACTICAL SYSTEMS // 4 PILLARS",
      ...
      card1_title: "Instance Container Isolation",
      card1_jp: "「完全独立・コンテナ分離」",
      card1_desc: "Every instance is a self-contained environment. Mods, saves, shaders, Java, and JVM arguments are isolated — testing new modpacks never harms existing worlds.",
