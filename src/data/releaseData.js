export const RELEASE_INFO = {
  ...
  changelog: [
    ...
    },
    {
      ...
      desc_vi: "Định dạng đóng gói tệp thực thi duy nhất chống quét nhầm mã độc, tối ưu hóa kích thước và tương thích hoàn toàn với cụm máy chủ tải tốc độ cao tại Hồng Kông & Singapore.",
...
export const I18N = {
  vi: {
    ...
    hero: {
      ...
      subtitle: "Nền tảng khởi chạy Minecraft mã nguồn mở với kiến trúc khoang độc lập 100%. Vượt qua rào cản đường dẫn dài Windows, tự động cấp phát Java Temurin và đồng bộ cụm Server Châu Á (Hồng Kông / Singapore) tốc độ cao.",
      btn_download: "Tải v1.6.1 Ngay",
      btn_explore: "Khám Phá Tính Năng",
      stat_loaders: "4 Mod Loaders Hỗ Trợ",
      stat_open: "100% Mã Nguồn Mở",
      stat_speed: "Server Châu Á Siêu Tốc",
    },
    features: {
  ...
  en: {
    ...
    hero: {
      ...
      stat_speed: "Asia Edge Fast (HKG/SIN)",
    },
    features: {
